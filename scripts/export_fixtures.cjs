...
if (pMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_products.cjs');
...
if (supMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_suppliers.cjs');
  fs.writeFileSync(tmpFile, code);
...
if (ordMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_orders.cjs');
  fs.writeFileSync(tmpFile, code);
...
if (userMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_users.cjs');
  fs.writeFileSync(tmpFile, code);
...
if (subMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_sub.cjs');
  fs.writeFileSync(tmpFile, code);
...
if (varMatch) {
  ...
  const tmpFile = path.join(__dirname, 'tmp_var.cjs');
  fs.writeFileSync(tmpFile, code);
