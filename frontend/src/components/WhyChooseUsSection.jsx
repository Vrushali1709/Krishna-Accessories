...
const DIFFERENCE_ITEMS = [
  {
    ...
    text: 'Every product comes with brand packaging, invoice, and manufacturer warranty.'
  },
  {
    number: '02',
    icon: TruckIcon,
    title: 'Insured Logistics',
    text: 'Dispatched securely via courier partners with live SMS and WhatsApp tracking.'
  },
  {
    number: '03',
    icon: RefreshIcon,
    title: '7-Day Return Policy',
    text: 'Hassle-free 7-day exchanges or returns for complete peace of mind.'
  },
  {
    number: '04',
    icon: HeadphonesIcon,
    title: 'VIP Support',
    text: 'Dedicated assistance directly from our store team for personalized recommendations.'
  }
];
    ...
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <Reveal direction="up" delay={50}>
        <div className="mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-light tracking-tight text-neutral-900">
            Why Shop <span className="font-semibold">With Us</span>
          </h2>
        </div>
      </Reveal>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {items.map((item, idx) => {
          const Icon = item.icon || ShieldCheckIcon;
          return (
            <Reveal key={item.number} direction="up" delay={idx * 60}>
              <div className="rounded-2xl border border-neutral-200/80 bg-white p-6 transition-all duration-300 hover:border-neutral-300 hover:shadow-[0_10px_25px_rgba(0,0,0,0.03)] flex flex-col justify-between h-full">
                <div>
