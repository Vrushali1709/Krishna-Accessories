...
export default function AdminDashboard() {
  ...
  const handleSaveProduct = (e) => {
    ...
    const fallbackImage = 'https://images.unsplash.com/photo-1548171915-e79a380a2a4b?w=800';
  ...
  return (
    <div className="h-screen max-h-screen w-full bg-[#F9F9F8] text-zinc-900 flex overflow-hidden font-sans selection:bg-zinc-900 selection:text-white">
        ...
        <div className="flex flex-col min-h-0 flex-1 overflow-hidden">
          ...
          <nav className="flex-1 overflow-y-auto min-h-0 p-3 space-y-1 text-xs">
            {navSections.map((sec) => {
              ...
              const hasMultipleSubItems = sec.subItems && sec.subItems.length > 1;
              ...
              return (
                <div key={sec.id} className="space-y-0.5">
                  ...
                  {/* Sub-items List (Rendered when expanded and has multiple sub-tabs) */}
                  {!sidebarCollapsed && isExpanded && hasMultipleSubItems && (
      ...
      >
        ...
        {/* Section Sub-Navigation Tabs Bar (Only rendered for sections with multiple tabs) */}
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
                ...
                <div
                  ...
                  title="Click to view payments & transactions"
                  className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-2xs hover:border-zinc-400 hover:shadow-xs cursor-pointer transition group"
                >
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5 flex items-center justify-between">
                    ...
                    <span className="text-zinc-600 group-hover:text-zinc-950 font-medium transition">View &rarr;</span>
                  </p>
                </div>
                ...
                <div
                  ...
                  title="Click to manage orders & fulfillment"
                  className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-2xs hover:border-zinc-400 hover:shadow-xs cursor-pointer transition group"
                >
                  <div className="flex items-center justify-between text-zinc-400 text-xs mb-1">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5 flex items-center justify-between">
                    ...
                    <span className="text-zinc-600 group-hover:text-zinc-950 font-medium transition">Manage &rarr;</span>
                  </p>
                </div>
                ...
                <div
                  ...
                  title="Click to manage product catalog"
                  className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-2xs hover:border-zinc-400 hover:shadow-xs cursor-pointer transition group"
                >
                  <div className="flex items-center justify-between text-zinc-400 text-xs mb-1">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5 flex items-center justify-between">
                    <span>{brands.length} luxury brands</span>
                    <span className="text-zinc-600 group-hover:text-zinc-950 font-medium transition">Catalog &rarr;</span>
                  </p>
                </div>
                ...
                <div
                  ...
                  title="Click to manage suppliers & vendors"
                  className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-2xs hover:border-zinc-400 hover:shadow-xs cursor-pointer transition group"
                >
                  <div className="flex items-center justify-between text-zinc-400 text-xs mb-1">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5 flex items-center justify-between">
                    ...
                    <span className="text-zinc-600 group-hover:text-zinc-950 font-medium transition">Suppliers &rarr;</span>
                  </p>
                </div>
                ...
                <div
                  ...
                  className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-2xs hover:border-zinc-400 hover:shadow-xs cursor-pointer col-span-2 sm:col-span-1 transition group"
                >
                  <div className="flex items-center justify-between text-zinc-400 text-xs mb-1">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5 flex items-center justify-between">
                    ...
                    <span className="text-zinc-600 group-hover:text-zinc-950 font-medium transition">Users &rarr;</span>
                  </p>
                </div>

              </div>

              {/* Pending Governance Actions Highlight */}
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              {activeSubTab === 'products' && (
                <div className="space-y-5">
                  ...
                  {/* Search & Filter Bar */}
                  <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 rounded-xl border border-zinc-200/80 bg-white p-3 shadow-2xs">
                    <div className="relative">
                      <input
                        type="text"
                        value={searchCatalog}
                    ...
                    <div className="flex items-center gap-1 overflow-x-auto pb-1 max-w-full">
                      {['All', 'Confirmed', 'Processing', 'Shipped', 'Delivered', 'Return Requested', 'Refunded', 'Cancelled'].map(st => (
                        <button
                          ...
                          className={`rounded-lg px-2.5 py-1 text-xs font-medium transition whitespace-nowrap cursor-pointer ${orderStatusFilter === st
                            ? 'bg-zinc-900 text-white shadow-xs'
                        ...
                        {products.map(p => {
                          ...
                          return (
                            <tr key={p.id} className="hover:bg-zinc-50/75">
                              ...
                              <td className="p-3.5">
                                <span className={`rounded-full px-2.5 py-0.5 text-[10px] font-medium border ${stock <= 0 ? 'bg-rose-50 text-rose-800 border-rose-200' : stock < 5 ? 'bg-amber-50 text-amber-800 border-amber-200' : 'bg-emerald-50 text-emerald-800 border-emerald-200'
                                  }`}>
                  ...
                  <div className="rounded-xl border border-zinc-200/80 bg-white p-5 shadow-2xs space-y-4 text-xs">
                    ...
                    <div className="flex items-center justify-between pb-3 border-b border-zinc-100">
                      ...
                      <button
                        ...
                        className={`rounded-full px-3 py-1 text-xs font-semibold transition cursor-pointer ${systemConfig.maintenanceMode ? 'bg-rose-600 text-white' : 'bg-zinc-100 text-zinc-700 hover:bg-zinc-200'
                          }`}
                      >
      ...
      {productModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs animate-fade-in">
          <div className="w-full max-w-3xl max-h-[92vh] overflow-y-auto rounded-2xl border border-zinc-200 bg-white p-5 sm:p-6 shadow-2xl">
          ...
          <div className="w-full max-w-lg rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl space-y-4 text-xs max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleProcessAdminReturn} className="space-y-3.5">
              ...
              <div className="pt-2 flex justify-end gap-2 border-t border-zinc-100">
                ...
                <button
                  type="submit"
                  className={`rounded-lg px-5 py-2 font-semibold text-white shadow-xs cursor-pointer ${adminReturnDecision === 'Return Rejected'
