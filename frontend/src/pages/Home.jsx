...
// ============================================================
// CONTINUOUS SCROLLING TICKER ITEMS
// ============================================================
const storeTickerItems = [
  {
    badge: 'SPECIAL OFFER',
...
const brandRow1 = [
  {
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1.5 sm:gap-2">
        <svg viewBox="0 0 32 32" className="h-5 w-5 sm:h-6 sm:w-6 text-gray-900 fill-current">
          <path d="M5 8h22v4h-8.5v16h-5V12H5V8z M16 1.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6z" />
        </svg>
        <span className="font-sans font-bold text-xs sm:text-sm tracking-[0.18em] text-gray-900">TITAN</span>
      </div>
    )
  },
  {
    ...
    renderLogo: () => (
      <div className="flex flex-col items-center justify-center">
        ...
        <span className="font-serif font-bold text-[9px] tracking-[0.2em] text-[#006039] leading-tight mt-0.5">ROLEX</span>
      </div>
    )
  },
  {
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1.5 sm:gap-2">
        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#3D2314] text-white font-black text-[10px]">F</span>
        <span className="font-sans font-black text-xs sm:text-sm tracking-[0.14em] text-gray-900">FOSSIL</span>
      </div>
    )
  },
  {
    ...
    cat: 'Watches',
    renderLogo: () => (
      <span className="font-sans font-black text-sm sm:text-base tracking-[0.12em] text-[#003B95]">CASIO</span>
    )
  },
  {
    name: 'Nike',
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1.5">
        <svg viewBox="0 0 24 24" className="h-5 w-8 fill-current text-gray-900">
          <path d={siNike.path} />
        </svg>
        <span className="font-sans font-black text-xs tracking-wider text-gray-900 italic">NIKE</span>
      </div>
    )
  },
  {
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1.5">
        <svg viewBox="0 0 24 24" className="h-5 w-6 fill-current text-gray-900">
          <path d={siAdidas.path} />
        </svg>
        <span className="font-sans font-bold text-xs tracking-wide text-gray-900">adidas</span>
      </div>
    )
  },
  {
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1">
        ...
        <span className="font-sans font-semibold text-xs tracking-tight text-gray-900">Apple</span>
      </div>
    )
  },
  {
    ...
    cat: 'Mobiles',
    renderLogo: () => (
      <span className="font-sans font-black text-xs tracking-[0.18em] text-[#034EA2]">SAMSUNG</span>
    )
  }
];
...
const brandRow2 = [
  {
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1.5">
        ...
        <span className="font-sans font-black text-xs tracking-wider text-gray-900">PUMA</span>
      </div>
    )
  },
  {
    ...
    cat: 'Electronics',
    renderLogo: () => (
      <span className="font-serif font-black text-sm tracking-[0.2em] text-gray-900">SONY</span>
    )
  },
  {
    name: 'Bose',
    cat: 'Electronics',
    renderLogo: () => (
      <span className="font-serif italic font-black text-sm tracking-[0.14em] text-gray-900">BOSE</span>
    )
  },
  {
    name: 'Dell',
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1">
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current text-[#0076CE]">
          <path d={siDell.path} />
        </svg>
        <span className="font-sans font-bold text-xs tracking-[0.12em] text-[#0076CE]">DELL</span>
      </div>
    )
  },
  {
    ...
    cat: 'Clothes & Fashion',
    renderLogo: () => (
      <span className="font-serif font-black text-sm tracking-[0.24em] text-gray-900">ZARA</span>
    )
  },
  {
    name: 'Hidesign',
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1">
        ...
        <span className="font-serif font-bold text-[11px] tracking-[0.16em] text-gray-900">HIDESIGN</span>
      </div>
    )
  },
  {
    ...
    cat: 'Fashion Accessories',
    renderLogo: () => (
      <span className="font-serif italic font-black text-sm text-[#E31837] tracking-tight">Ray•Ban</span>
    )
  },
  {
    name: 'Razer',
    ...
    renderLogo: () => (
      <div className="flex items-center gap-1">
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current text-[#00E700]">
          <path d={siRazer.path} />
        </svg>
        <span className="font-sans font-black text-[11px] tracking-[0.16em] text-gray-900">RAZER</span>
      </div>
    )
  }
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-gray-900 overflow-x-clip font-sans selection:bg-gray-900 selection:text-white">
      <Navbar />

      {/* Floating Alert Toast */}
      {toastMessage && (
        <div className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 rounded-xl border border-gray-200 bg-white/95 backdrop-blur-md px-4 py-3 text-xs font-semibold text-gray-900 shadow-xl animate-slide-up max-w-[calc(100vw-32px)]">
          ...
          <Link
            to="/cart"
            className="ml-2 rounded-lg bg-gray-900 px-3 py-1 text-[11px] font-semibold text-white hover:bg-black transition shrink-0 shadow-2xs"
          >
            View Bag
          </Link>
        </div>
      ...
      {/* =========================================================
          1. REFINED HERO SLIDER SECTION (Clean Minimalist Aesthetic)
      ========================================================= */}
      <section className="relative w-full overflow-hidden bg-[#111827] text-white border-b border-gray-200 lg:h-[620px] lg:min-h-[620px]">
        <div className="absolute inset-0">
          {watchHeroSlides.map((slide, index) => (
            <div
              key={slide.titleLine1}
            ...
            >
              <div className="absolute inset-0 lg:left-auto lg:right-0 lg:w-[54%] h-full w-full">
                <img
                  src={slide.image}
                  alt={slide.titleLine1}
                  className="h-full w-full object-cover object-center"
                />
                <div className="hidden lg:block absolute inset-y-0 left-0 w-36 bg-gradient-to-r from-[#111827] to-transparent pointer-events-none" />
              </div>

              <div className="absolute inset-0 bg-gradient-to-r from-[#111827] via-[#111827]/80 to-transparent pointer-events-none" />
            </div>
          ))}
        </div>

        <div className="relative z-20 mx-auto max-w-7xl w-full min-h-[520px] lg:h-full px-4 sm:px-6 lg:px-8 py-16 lg:py-0 flex flex-col justify-between">
          <div className="max-w-xl lg:my-auto" key={`hero-slide-${currentSlide}`}>
            ...
            <Reveal direction="up" delay={80}>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
                ...
                <span className="text-gray-300">{watchHeroSlides[currentSlide].titleLine2}</span>
              </h1>
            </Reveal>

            <Reveal direction="up" delay={120}>
              <p className="mt-3 text-xs sm:text-sm text-gray-300 max-w-md font-normal leading-relaxed">
                {watchHeroSlides[currentSlide].description}
              </p>
            </Reveal>
            ...
            <Reveal direction="up" delay={160}>
              <div className="mt-6 flex items-center gap-3">
                <Link
                  to="/shop?category=Watches"
                  className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-xs font-semibold uppercase tracking-wider text-gray-950 transition hover:bg-gray-100 shadow-sm"
                >
                  <span>Shop Watches</span>
                ...
                <Link
                  to="/shop"
                  className="inline-flex items-center gap-2 rounded-xl border border-gray-600 bg-transparent px-6 py-3 text-xs font-semibold uppercase tracking-wider text-white transition hover:bg-white/10"
                >
                  <span>View All</span>
                </Link>
              </div>
              ...
              <div className="flex items-center gap-1.5">
                {watchHeroSlides.map((_, i) => (
                  <button
                    key={i}
                    onClick={() => setCurrentSlide(i)}
                    className={`h-1.5 rounded-full transition-all cursor-pointer ${i === currentSlide ? 'w-6 bg-white' : 'w-2 bg-gray-600'}`}
                    aria-label={`Go to slide ${i + 1}`}
                  />
                ))}
              </div>
      ...
      {/* =========================================================
          2. STORE OFFERS & ANNOUNCEMENT TICKER
      ========================================================= */}
      <div className="w-full bg-gray-900 text-white border-b border-gray-800 py-2.5 overflow-hidden select-none">
        <div className="animate-marquee flex items-center gap-6">
          {[...storeTickerItems, ...storeTickerItems].map((item, idx) => (
            <div
              key={idx}
              onClick={() => item.code && handleCopyCode(item.code)}
              className={`inline-flex items-center gap-2 shrink-0 ${item.code ? 'cursor-pointer hover:opacity-80' : ''}`}
            >
              <span className="text-amber-400 text-xs">✦</span>
              {item.badge && (
                <span className={`rounded px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider border ${item.badgeColor}`}>
                  {item.badge}
                </span>
              )}
              <span className="font-semibold text-xs tracking-wide text-white">{item.title}</span>
              <span className="text-[11px] text-gray-400">({item.subtitle})</span>
              {item.code && (
                <span className="ml-1 rounded bg-white/10 px-1.5 py-0.5 text-[10px] font-mono text-amber-300 border border-white/20">
                  {item.code}
                </span>
              )}
            </div>
      ...
      {/* =========================================================
          3. DISCOVERY STRIP (Service Highlights)
      ========================================================= */}
      <HomeDiscoveryStrip />
      ...
      {/* =========================================================
          5. FEATURED & TRENDING PRODUCTS (Tabbed Catalogue)
      ========================================================= */}
      <FeaturedTrendingSection
        products={products}
        onToast={setToastMessage}
      ...
      <section className="bg-white py-10 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <span className="text-[11px] font-semibold uppercase tracking-wider text-gray-400">Top Picks</span>
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 mt-0.5">Best Sellers</h2>
            </div>
            <Link to="/shop" className="text-xs font-semibold text-gray-900 hover:underline">
              View All &rarr;
            </Link>
          </div>
          ...
          {bestSellers.length > 0 ? (
            ...
            <div className="text-center py-10 text-xs text-gray-500">No products found.</div>
          )}
        </div>
      </section>
      ...
      <section className="bg-white py-10 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <span className="text-[11px] font-semibold uppercase tracking-wider text-gray-400">Fresh Releases</span>
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 mt-0.5">New Arrivals</h2>
            </div>
            <Link to="/shop" className="text-xs font-semibold text-gray-900 hover:underline">
              View All &rarr;
            </Link>
          ...
          {newArrivals.length > 0 ? (
            ...
            <div className="text-center py-10 text-xs text-gray-500">No new arrivals found.</div>
          )}
        </div>
      </section>
      ...
      {/* =========================================================
          9. BRAND PARTNERS
      ========================================================= */}
      <section className="mx-auto max-w-7xl px-4 py-10 lg:px-8 border-t border-gray-200">
        <div className="text-center mb-6">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900">Featured Brand Partners</h2>
          <p className="text-xs text-gray-500 mt-1">Authentic curation from world-renowned makers.</p>
        </div>
        ...
        <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-2xs">
          <div className="space-y-4">
            <div className="animate-marquee flex items-center gap-6 py-2">
              {[...brandRow1, ...brandRow1].map((b, idx) => (
                <Link
                  key={`${b.name}-t1-${idx}`}
                  to={`/shop?brand=${encodeURIComponent(b.name)}`}
                  className="flex-shrink-0 flex items-center justify-center w-40 h-16 rounded-xl border border-gray-100 bg-gray-50 px-4 hover:border-gray-300 transition"
                >
                  {b.renderLogo()}
                </Link>
              ))}
