                  ...
                  {categories.map((cat) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() => handleCategorySelect(cat)}
                        className={`w-full flex items-center justify-between rounded-lg px-3 py-1.5 text-xs transition cursor-pointer ${
                          isSelected
                    ...
                    return (
                      <label
                        ...
                        className={`flex cursor-pointer items-center justify-between rounded-lg px-2.5 py-1.5 text-xs transition ${
                          isSelected ? 'bg-gray-100 font-semibold text-gray-950' : 'text-gray-600 hover:bg-gray-50'
                        }`}
                      >
                        <div className="flex items-center gap-2 truncate">
                          <input
                ...
                <div className="space-y-1">
                  {PRICE_BRACKETS.map((bracket) => (
                    <button
                      ...
                      type="button"
                      onClick={() => handlePriceBracketSelect(bracket)}
                      className={`w-full text-left rounded-lg px-2.5 py-1.5 text-xs transition cursor-pointer flex items-center justify-between ${
