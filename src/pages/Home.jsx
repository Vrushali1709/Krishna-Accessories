...
// Hero Section Carousel માટે Watches સ્લાઈડ્સ
const watchSlides = [
  {
    id: 1,
    title: 'Heritage Swiss Luxury',
    subtitle: 'Classic Precision & Craftsmanship',
    image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1200&q=80',
  },
  {
    id: 2,
    title: 'Modern Automatic Chronographs',
    subtitle: 'Engineered for Performance',
    image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=1200&q=80',
  },
  {
    id: 3,
    title: 'Timeless Gold Editions',
    subtitle: 'Exclusive Luxury Collections',
...
export default function Home() {
  ...
  // Watch Carousel Auto-slide logic (4 seconds interval)
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % watchSlides.length);
    }, 4000);
  ...
  const prevSlide = () => {
    setCurrentSlide((prev) => (prev === 0 ? watchSlides.length - 1 : prev - 1));
  };
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#FDFBF7] via-[#FAF9F5] to-white border-b border-gray-200/80">
        <div className="mx-auto flex min-h-[460px] lg:min-h-[520px] max-w-7xl items-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
            ...
            {/* Right Column: Watches Carousel */}
            <div className="lg:col-span-7 relative animate-fade-in w-full">
              <div className="rounded-2xl sm:rounded-3xl border border-gray-200 bg-white p-2 sm:p-2.5 shadow-xl group relative">
                
                {/* Carousel Container */}
                <div className="relative aspect-[16/10] sm:aspect-[16/9] overflow-hidden rounded-xl sm:rounded-2xl bg-gray-100">
                  ...
                  <button
                    onClick={prevSlide}
                    className="absolute left-3 top-1/2 -translate-y-1/2 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 backdrop-blur-md text-gray-900 shadow-md hover:bg-white transition"
                  ...
                  <button
                    onClick={nextSlide}
                    className="absolute right-3 top-1/2 -translate-y-1/2 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 backdrop-blur-md text-gray-900 shadow-md hover:bg-white transition"
                ...
                <div className="mt-2 sm:mt-2.5 flex items-center justify-between gap-2.5 sm:gap-4 rounded-xl bg-[#FAF9F6] border border-gray-200/80 px-3 sm:px-4 py-2 sm:py-2.5">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-[10px] sm:text-[11.5px] font-bold uppercase tracking-wider text-gray-900 truncate">
                        {watchSlides[currentSlide].title}
                      </p>
                      <p className="text-[9px] sm:text-[10px] text-gray-500 truncate">
                        {watchSlides[currentSlide].subtitle}
                      </p>
                    </div>
                  </div>
                  <span className="hidden sm:inline-flex text-[9.5px] font-bold text-[#B89758] uppercase tracking-wider bg-amber-500/10 px-2.5 py-1 rounded-full border border-amber-500/20 shrink-0">
