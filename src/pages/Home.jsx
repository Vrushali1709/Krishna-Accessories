...
import PriveClubBanner from '../components/PriveClubBanner';
...
export default function Home() {
  ...
  // Update listener for products & categories
  useEffect(() => {
    const handleUpdate = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFB] text-gray-900 overflow-x-clip select-none sm:select-auto">
      ...
      {/* ================= 3. DISCOVERY STRIP (BENEFITS & ROUNDELS) ================= */}
      ...
      {/* ================= 5. FLASH DEAL OF THE DAY (REAL-TIME COUNTDOWN) ================= */}
      <FlashDealSection products={products} onToast={setToastMessage} />

      {/* ================= 6. BEST SELLERS (RANKED + CATEGORIZED) ================= */}
      <BestSellersSection products={products} onToast={setToastMessage} />

      {/* ================= 7. PRODUCTS BY PRICE (UNDER 5K, 10K, 15K, 20K) ================= */}
      <PriceRangeSection products={products} onToast={setToastMessage} />

      {/* ================= 8. CURATED STYLE COLLECTIONS (EDITORIAL LOOKBOOKS) ================= */}
      <CuratedCollectionsSection />

      {/* ================= 9. SELECTED EDITIONS (FEATURED PRODUCTS) ================= */}
      <section className="bg-white border-y border-gray-200/80 py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 sm:mb-8">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#B89758]">
                Curated Showcase
              </span>
      ...
      {/* ================= 10. THE NEW ARRIVALS (NOVELTIES CAROUSEL) ================= */}
      <NewArrivalsSection products={products} onToast={setToastMessage} />

      {/* ================= 11. FEATURED BRANDS (CARDS + DUAL MARQUEE) ================= */}
      <FeaturedBrandsSection />

      {/* ================= 12. PROMOTIONAL PRIVÉ VIP CLUB BANNER ================= */}
      <PriveClubBanner onToast={setToastMessage} />

      {/* ================= 13. WHY CHOOSE US (THE DIFFERENCE) ================= */}
      <WhyChooseUsSection />
