...
import TrustServicesBar from '../components/TrustServicesBar';
import FlashDealsSection from '../components/FlashDealsSection';
import FeaturedBrandsSection from '../components/FeaturedBrandsSection';
import LifestyleCollectionsSection from '../components/LifestyleCollectionsSection';
import TrendingBestSellersSection from '../components/TrendingBestSellersSection';
import SocialLookbookSection from '../components/SocialLookbookSection';
...
const watchHeroSlides = [
  {
    ...
    description: 'Where timeless design meets modern performance. Certified authentic Swiss & automatic watches.',
    image: 'https://i.pinimg.com/736x/80/4d/7c/804d7c5ba3d69a866d1303f94299d564.jpg'
  },
  {
    tag: 'LIMITED EDITION',
    ...
    description: 'Engineered for absolute accuracy, sapphire crystal durability, and iconic luxury prestige.',
  ...
  },
  {
    ...
    description: 'Crafted with sapphire crystal and fine Italian calfskin leather bands for discerning connoisseurs.',
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFB] text-gray-900 overflow-x-clip select-none sm:select-auto">
      ...
      {/* ================= 2. CONTINUOUS TICKER LINE (INFINITE MARQUEE) ================= */}
      ...
      {/* ================= 3. TRUST & SERVICES GUARANTEE BAR ================= */}
      <TrustServicesBar />

      {/* ================= 4. QUICK DISCOVERY CATEGORIES STRIP ================= */}
      <HomeDiscoveryStrip categories={categoryList} />

      {/* ================= 5. CURATED DEPARTMENTS CAROUSEL ================= */}
      ...
      {/* ================= 6. LIMITED-TIME FLASH DEALS (WITH LIVE COUNTDOWN) ================= */}
      <FlashDealsSection products={products} onToast={setToastMessage} />
      ...
      {/* ================= 8. FEATURED BRANDS (USER REQUESTED SHOWCASE & MARQUEE) ================= */}
      <FeaturedBrandsSection products={products} />

      {/* ================= 9. CURATED LIFESTYLE OCCASIONS & STYLE GUIDES ================= */}
      <LifestyleCollectionsSection />

      {/* ================= 10. SELECTED EDITIONS (CATEGORY FILTERED PRODUCTS) ================= */}
      ...
      {/* ================= 11. TRENDING & BEST SELLERS TABBED SHOWCASE ================= */}
      <TrendingBestSellersSection
        products={products}
        onAddToCart={handleAddToCart}
        onBuyNow={handleBuyNow}
      />
      ...
      {/* ================= 13. SOCIAL COMMUNITY & LOOKBOOK (#StyledWithKrishna) ================= */}
      <SocialLookbookSection />

      {/* ================= 14. CUSTOMER REVIEWS (CAROUSEL) ================= */}
      <CustomerReviewsSection />

      {/* ================= 15. WHY CHOOSE US (THE DIFFERENCE) ================= */}
      <WhyChooseUsSection />

      {/* ================= 16. KRISHNA PRIVÉ VIP CLUB & NEWSLETTER ================= */}
