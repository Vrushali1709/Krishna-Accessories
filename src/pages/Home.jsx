...
const watchHeroSlides = [
  {
    ...
    subtitle: 'Heritage Swiss Timepieces',
    ...
    image: 'https://i.pinimg.com/736x/80/4d/7c/804d7c5ba3d69a866d1303f94299d564.jpg',
    tag: 'Swiss Chronographs'
  },
  {
    title: 'Masterpiece in Gold',
    subtitle: 'Automatic Royal Edition',
  ...
  },
  {
    ...
    subtitle: 'Urban Steel Series',
    description: 'Sleek matte finishes paired with genuine leather straps. Designed to transition seamlessly from boardroom meetings to evening galas.',
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFB] text-gray-900 overflow-x-clip select-none sm:select-auto">
      ...
      {/* ================= FULL SCREEN WATCH HERO CAROUSEL SECTION ================= */}
      <section className="relative overflow-hidden bg-[#EFECE6] border-b border-gray-300/60 min-h-[520px] lg:min-h-[600px] flex items-center">
        {/* Background Watch Slides */}
        {watchHeroSlides.map((slide, index) => (
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[#F3F0EC] via-[#EFECE6]/80 to-transparent z-10 lg:w-2/3" />
            <img
              src={slide.image}
              alt={slide.title}
        ...
        <div className="relative z-20 mx-auto max-w-7xl w-full px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/80 backdrop-blur-md px-3.5 py-1 mb-5 border border-amber-500/30 shadow-xs">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold tracking-tight text-gray-950 font-serif leading-[1.1]">
              {watchHeroSlides[currentSlide].title}
            </h1>

            <p className="mt-4 text-sm sm:text-base leading-relaxed text-gray-700 max-w-lg font-normal">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 rounded-full border border-gray-400/80 bg-white/80 backdrop-blur-md px-7 py-3.5 text-xs sm:text-sm font-semibold uppercase tracking-wider text-gray-900 transition hover:bg-white shadow-xs"
              >
              ...
              {watchHeroSlides.map((_, idx) => (
                <button
                  ...
                  className={`h-2 transition-all rounded-full ${
                    idx === currentSlide ? 'w-8 bg-gray-900' : 'w-2 bg-gray-400/60 hover:bg-gray-600'
                  }`}
                />
              ))}
            </div>
