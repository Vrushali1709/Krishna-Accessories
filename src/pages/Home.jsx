...
export default function Home() {
  ...
  // UPDATED: "Selected Editions" now shows the highest-rated products first
  // instead of just the first 8 items in the raw list, so top-rated items
  // (Titan, Rolex, Hidesign etc. with 4.8+ rating) surface automatically.
  ...
  // UPDATED: Brand showcase is now derived directly from live product data
  // instead of a hardcoded list. When Admin adds a new brand/product via
  // AdminProducts.jsx, it will automatically appear here without any code change.
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFB] text-gray-900 overflow-x-clip">
            ...
            <div className="lg:col-span-7 relative animate-fade-in w-full">
              <div className="rounded-2xl sm:rounded-3xl border border-gray-200 bg-white p-2 sm:p-2.5 shadow-xl group">
                <div className="overflow-hidden rounded-xl sm:rounded-2xl">
                  <img
                    /*
                      UPDATED: Original path "/images/hero-luxury-bright.jpg" pointed to a
                      local file that isn't in the project uploads, which would show as a
                      broken image. Swapped to a reliable hosted Unsplash image so the hero
                      always renders. If you DO have hero-luxury-bright.jpg inside your own
                      public/images folder, just change the src back to "/images/hero-luxury-bright.jpg".
                    */
      ...
      {/* ================= FEATURED RECOMMENDATIONS (now rating-sorted) ================= */}
      <section className="bg-white border-y border-gray-200/80 py-8 sm:py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* ================= CATEGORY-WISE BRAND SHOWCASE (now dynamic) ================= */}
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <div className="text-center mb-5">
          <span className="text-[9px] font-semibold uppercase tracking-[0.14em] text-gray-400">Official Brand Partners</span>
          <h2 className="mt-0.5 text-lg sm:text-xl font-bold tracking-tight text-gray-950">Explore by Brand</h2>
