    ...
    <div className="min-h-screen bg-[#FAFAFB] text-gray-900 selection:bg-amber-100 selection:text-amber-900">
      ...
      <main className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-start">
          ...
          {/* Left Column: 4-Angle Multi-Image Showcase (5 Cols on LG) */}
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            ...
            <div className="relative group aspect-square overflow-hidden rounded-3xl border border-gray-200/90 bg-white p-6 sm:p-8 flex items-center justify-center shadow-sm">
              ...
              <button
                ...
                title="Open 360° Fullscreen Lightbox"
              >
            ...
            {images.length > 1 && (
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-[11px] text-gray-500 px-1">
                  <span className="font-semibold text-gray-700 uppercase tracking-wider text-[10px]">Multi-Angle Views ({images.length} Angles):</span>
            ...
            <div className="grid grid-cols-3 gap-2 rounded-2xl border border-gray-200/80 bg-white p-3 sm:p-3.5 text-center shadow-xs">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-[11px] font-bold text-gray-950">100% Genuine</p>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-[9.5px] text-gray-500">Hassle-Free Refunds</p>
              </div>
            </div>

          </div>

          {/* Right Column: Product Variations & Interactive Buy Box (7 Cols on LG) */}
              ...
              <div className="mt-1 flex items-center justify-between text-[11px] text-gray-500">
                ...
                {variantDelta > 0 && (
                  <span className="font-semibold text-amber-700 bg-amber-50 px-2 py-0.2 rounded border border-amber-200">
                    +₹{variantDelta.toLocaleString('en-IN')} edition delta applied
                  </span>
                )}
              </div>
            </div>
            ...
            {activeTab === 'specs' && (
              <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 animate-fade-in">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between border-b border-gray-100 py-2 text-xs gap-2">
                    <span className="text-gray-500 font-medium">Authorized Distributor</span>
            ...
            {activeTab === 'delivery' && (
              <div className="space-y-3 text-xs text-gray-700 leading-relaxed animate-fade-in">
                <div className="rounded-xl bg-gray-50 p-3.5 border border-gray-200/80">
                  ...
                  <p>Orders placed before 2:00 PM are dispatched same day via BlueDart Apex Air or Delhivery Surface. Orders valued at ₹2,000 or above receive 100% complimentary express delivery.</p>
                </div>
                <div className="rounded-xl bg-gray-50 p-3.5 border border-gray-200/80">
                ...
                <div className="rounded-xl bg-gray-50 p-3.5 border border-gray-200/80">
                  <p className="font-bold text-gray-900 mb-1">🛡️ Authenticity Certificate & 2-Year Official Warranty:</p>
                  <p>Every piece undergoes a multi-point inspection by certified boutique horologists/experts and arrives with an individually numbered warranty booklet.</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fade-in">
          <div className="w-full max-w-lg rounded-3xl border border-gray-200 bg-white p-6 sm:p-7 shadow-2xl text-gray-900">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3 mb-4">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#B89758]">Official Sizing Reference</span>
