      ...
      <div className="w-full px-3 sm:px-6 lg:px-8 xl:px-10 border-b border-gray-200/80">
        <div className="relative flex h-14 sm:h-16 items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 ml-auto z-10">
            ...
            {/* Notifications Popover (Hidden on ultra-small mobile, visible in drawer & sm+) */}
            ...
            {/* Wishlist Button (Hidden on ultra-small mobile, visible in drawer & sm+) */}
            <Link
              to="/wishlist"
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div
            ...
            className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs transition-opacity xl:hidden animate-fade-in"
          />

          {/* Drawer Slide-in Container */}
          <div className="fixed top-0 bottom-0 right-0 z-50 w-[88vw] max-w-[380px] bg-white shadow-2xl flex flex-col xl:hidden animate-fade-in divide-y divide-gray-100 overflow-hidden">
            ...
            <div className="px-4 py-3.5 flex items-center justify-between bg-[#FAFAFB]">
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200/80 text-gray-700 hover:bg-gray-300 transition cursor-pointer shrink-0"
              >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center rounded-2xl bg-gray-50 border border-gray-100 p-2 text-center hover:bg-gray-100 transition relative cursor-pointer"
                >
                  <div className="relative mb-1">
                  ...
                  <span className="text-[10px] font-bold text-gray-700 leading-none">Alerts</span>
                </button>
            ...
            {/* Drawer Footer */}
            <div className="bg-[#0B1120] text-slate-300 p-3.5 space-y-2.5">
