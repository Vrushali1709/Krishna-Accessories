      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 sm:mb-8">
          ...
          <div className="flex items-center justify-between md:justify-end gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 shrink-0 pl-3 border-l border-gray-200">
              <button
                type="button"
                ...
                className={`flex h-8 w-8 items-center justify-center rounded-full border transition-all duration-200 ${
                  canScrollLeft
                    ? 'border-gray-300 bg-white text-gray-900 hover:bg-gray-900 hover:text-white hover:border-gray-900 cursor-pointer shadow-2xs active:scale-95'
