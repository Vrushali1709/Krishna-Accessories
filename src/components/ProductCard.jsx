      ...
      <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-[#F4F3F0]">
        ...
        <div className="absolute top-2.5 inset-x-2.5 z-10 flex items-center justify-between pointer-events-none">
          ...
          <button
            ...
            className={`pointer-events-auto flex h-7.5 w-7.5 items-center justify-center rounded-full shadow-xs backdrop-blur-md transition-all duration-300 hover:scale-115 active:scale-90 cursor-pointer ${inWish
      ...
      <div className="pt-3.5 flex flex-1 flex-col justify-between text-center">
        ...
        <div className="mt-3.5">
          <button
            ...
            className={`w-full py-2.5 px-3 rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-300 active:scale-98 shadow-xs flex items-center justify-center gap-2 cursor-pointer ${justAdded
